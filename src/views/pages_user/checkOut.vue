              ...
              <v-col cols="12" md="6" lg="6">
                <div style="margin-right: 30px">
                  ...
                  <div style="display: flex; flex-direction: column">
                    ...
                    <!--            địa chỉ -->
                    <div
                      class="tch_deli_address tch_delivery_card fix_position"
                      style="float: left"
                    >
                      ...
                      <div class="tch_delivery_content" style="flex: 1">
                        ...
                        <span>
                          <v-icon color="black" right x-large
                    ...
                    <!--            thời gian giao hàng -->
                    <div
                      class="time_deli fix_position"
                      style="padding-left: 40px; margin-left: 50px"
                    >
                  ...
                  <div style="display: flex; flex-direction: column">
                    ...
                    <div class="policy">
                      <label
                        class="checkbox-button fix_position"
                        style="margin-left: 50px"
                      >
                        <input
                          checked="checked"
                  ...
                  >
                    <p
                      class="tch-checkout-box__text text-center mb-0 fix_position"
                    >
                ...
                >
                  <div class="px-5">
                    <div class="py-3">
                      ...
                      <div
                        class="tch-order-card product_chose_item"
                        v-for="(order, index) in orders"
                        :key="index"
                        style="display: inherit"
                      >
                        <div
                          v-for="product in order.product_item"
                          :key="product.name"
                          ...
                          <div class="tch-order-card__left" style="display: flex">
                            ...
                            <div class="tch-order-card__content">
                              ...
                              <p
                                ...
                                v-if="order.topping_items.length >1 "
                              >
                              ...
                              <v-btn
                                size="x-small"
                                v-on:click="handleDeleteOne(order)"
                                >xóa</v-btn
                              >
                      ...
                      <!--thanh toán -->
                      <div
                        class="tch-checkout-box tch-checkout-box--list-total tch-checkout-border"
                      ...
                      >
                        ...
                        <div
                          class="tch-order-card tch-order-card--border product_chose_item"
                        >
                          <div class="tch-order-card__left" style="display: flex">
                            ...
                            <v-row justify="center">
                              ...
                              >
                                <template v-slot:activator="{ on, attrs }">
                                  <div class="tch-order-card__left d-flex">
                                    <p
                                      class="tch-order-card__text mb-0"
                                      style="color: #fa8c16"
                                      v-bind="attrs"
                                      v-on="on"
                                    >
                                  ...
                                  <div class="modal_body">
                                    <div class="card_product">
                                      ...
                                      <div class="card-product-note-item">
                                        ...
                                        <v-btn
                                          class="btn-add-item"
                                          @click="handleChoseItem"
                                          >Áp dụng</v-btn
                                        >
                                      </div>
                                      <div>
                                        <div class="card-product-option">
                                          <span class="card-product-option-text"
                                            >SẴN SÀNG SỬ DỤNG</span
                                          >
                                        </div>
                                        <div>
                                          <div
                                            ...
                                            <v-row class="ma-0">
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  >
                                                  <span
                                                    class="card_product_description"
                                                    style="color: #fa8c16"
                                                    >hết hạn
                                                    {{ item.end_date }}</span
                                                  ><br />
                  ...
                  <div
                    class="tch-checkout-box--list-submited position-static"
...
export default {
    ...
    created() {
        if (JSON.parse(localStorage.getItem("order")) != null) {
            ...
            this.getVoucher()
            this.money_pay = this.get_totalprice()
